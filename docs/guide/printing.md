...
You can print order slips from the Kitchen Display. Click the printer icon on an
order card to choose a printer.
...
1. Configure your printers in the Point of Sale settings.
2. For ePOS printers, set the printer IP address on the Point of Sale.
3. For local printing, connect a printer to the device running the display.

## Print mode

For the local printer, choose the print mode in the display settings:
